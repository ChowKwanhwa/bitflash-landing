...
export const translations = {
    en: {
        ...
        vision: {
            title: "Reinventing",
            highlight: "Consensus",
            description1: "Flash is not just a prediction platform; it represents the evolution of truth. By leveraging the Bitcoin Lightning Network, we restore the original promise of decentralized consensus—fast, fair, and immutable.",
        ...
        ecosystem: {
            ...
            p1: { title: "Flash Predict", desc: "The core prediction market DApp. Trade on sports, crypto prices, and global events." },
        ...
        roadmap: {
            ...
            p3: { phase: "H2 2026", title: "Testnet & MVP", items: ["Flash Predict Live (Testnet)", "SportRadar API Integration", "DAO Governance Framework", "Public Beta Testing"] },
        ...
        footer: {
            ...
            poweredByPrefix: "Flash Network. Powered by",
        }
    },
    zh: {
        nav: {
        ...
        vision: {
            title: "重塑",
            highlight: "共识",
            description1: "闪电 (Flash) 远不止于预测市场，它是真理发现机制的终极进化。基于比特币闪电网络，我们重拾去中心化共识的初心——极速、公平、不可篡改。",
            description2: "我们正在构建一个如水般流动、如光般迅捷的信息市场。无许可准入，零延迟结算，唯有纯粹的市场效率。"
        },
        ecosystem: {
            title: "加入",
            subtitle: "由 BitBoom 协议驱动的跨应用统一流动性层。",
            p1: { title: "闪电预测", desc: "核心预测市场 DApp。交易体育赛事、加密货币价格和全球事件。" },
        ...
        roadmap: {
            ...
            p3: { phase: "2026 下半年", title: "测试网与 MVP", items: ["闪电预测市场 (测试网)", "SportRadar API 集成", "DAO 治理框架", "公开 Beta 测试"] },
